...
namespace InsightDataScience
{
    ...
    {
        /// <summary>
        /// C:\Users\sima\Documents\Visual Studio 2015\Projects\coding-challenge-master\coding-challenge-master\insight_testsuite\tests\test-2-tweets-all-distinct\tweet_input
        /// I have considered three pathes for input and output files as constant
        /// </summary>
        private SlidingWindow _slidingWindows;
        private const string _filePath = @"..\\..\\tweet_input\tweets.txt";//@"C:\Users\sima\Documents\Visual Studio 2015\InsightDataScience\InsightDataScience\bin\Debug\tweets.txt";//@"..\\..\\coding-challenge-master\tweet_input\tweets.txt";
        private const string _outPutTwoPath = @"..\\..\\tweet_output\output.txt";// @"C:\Users\sima\Documents\Visual Studio 2015\InsightDataScience\InsightDataScience\bin\Debug\output.txt";// @"..\\..\\coding-challenge-master\tweet_output\output.txt";
